...
│   ├── enums/                # user_role · approval_status · task_* · task_assignment_type · template_repeat_mode · recurrence_frequency · notification_type · schedule_day · schedule_shift · leave_type · swap_status · broadcast_audience · broadcast_category · broadcast_recurrence · case_category · case_recipient · case_privacy · case_status · request_type · request_status
