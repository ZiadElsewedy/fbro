...
| **Tests** | **1059 pass · 5 fail** across 154 files (~24s) — all 5 are pre-existing and reproduce on a clean tree (2 splash-centering + 3 notification-probe); see [Known issues](#known-issues). Cloud Functions: **34 pass**; NestJS chat backend: **84 pass** (`cd ~/Desktop/Developer/drop-api && npx jest`) |
...
flutter test                             # expect: 1059 pass, 5 fail (pre-existing: 2 splash + 3 notif-probe)
